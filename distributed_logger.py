...
def generate_graphs(file_path):
    ...
    plt.xlabel('Time (s)')
    plt.ylabel('Delay (s)')
    plt.title('Minimum Message Delay Per Second')
    plt.savefig('min_delay.png', dpi=600, bbox_inches='tight')
    plt.clf()
    ...
    plt.xlabel('Time (s)')
    plt.ylabel('Delay (s)')
    plt.title('Maximum Message Delay Per Second')
    plt.savefig('max_delay.png', dpi=600, bbox_inches='tight')
    plt.clf()
    ...
    plt.xlabel('Time (s)')
    plt.ylabel('Delay (s)')
    plt.title('Median Message Delay Per Second')
    plt.savefig('median_delay.png', dpi=600, bbox_inches='tight')
    plt.clf()
    ...
    plt.xlabel('Time (s)')
    plt.ylabel('Delay (s)')
    plt.title('90th Percentile Message Delay Per Second')
    plt.savefig('ninetieth-delay.png', dpi=600, bbox_inches='tight')
    plt.clf()
